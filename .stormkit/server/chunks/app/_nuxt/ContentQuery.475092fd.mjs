...
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.03f070f8.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/vue';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.1c08b10d.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=ContentQuery.475092fd.mjs.map
