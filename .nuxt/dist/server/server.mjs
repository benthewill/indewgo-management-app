...
const components = {
  ContentDoc: defineAsyncComponent(() => import("./_nuxt/ContentDoc.97d39b0c.js").then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import("./_nuxt/ContentList.21a5a747.js").then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import("./_nuxt/ContentNavigation.98869a91.js").then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import("./_nuxt/ContentQuery.0635b07b.js").then((n) => n.C).then((c) => c.default || c)),
  ContentRenderer: defineAsyncComponent(() => import("./_nuxt/ContentRenderer.e5c3fd59.js").then((c) => c.default || c)),
  ContentRendererMarkdown: defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown.2bebb955.js").then((c) => c.default || c)),
  ContentSlot: defineAsyncComponent(() => import("./_nuxt/ContentSlot.2e8c5b3c.js").then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import("./_nuxt/Markdown.f8be56dc.js").then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import("./_nuxt/ProseA.992e43db.js").then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.c0fe3190.js").then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import("./_nuxt/ProseCode.6f2f59d8.js").then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.7717047f.js").then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import("./_nuxt/ProseEm.a60331d7.js").then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import("./_nuxt/ProseH1.c30f1477.js").then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import("./_nuxt/ProseH2.8213f95f.js").then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import("./_nuxt/ProseH3.fb1ebd6d.js").then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import("./_nuxt/ProseH4.dd0dcfe6.js").then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import("./_nuxt/ProseH5.8ed46a79.js").then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import("./_nuxt/ProseH6.5404d56b.js").then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import("./_nuxt/ProseHr.e1aa79eb.js").then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import("./_nuxt/ProseImg.4debdb73.js").then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import("./_nuxt/ProseLi.8c69ded3.js").then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import("./_nuxt/ProseOl.329ed22d.js").then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import("./_nuxt/ProseP.d5b4f3bd.js").then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import("./_nuxt/ProseStrong.59218617.js").then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import("./_nuxt/ProseTable.9f1f7b3a.js").then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import("./_nuxt/ProseTbody.c5e3156c.js").then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import("./_nuxt/ProseTd.590dc7d0.js").then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import("./_nuxt/ProseTh.97fb6184.js").then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import("./_nuxt/ProseThead.65b2faed.js").then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import("./_nuxt/ProseTr.85d6afe3.js").then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import("./_nuxt/ProseUl.719bc492.js").then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/Home.31ebcae6.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/addNewLot.60aaad20.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.96169c34.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.42cb2668.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
