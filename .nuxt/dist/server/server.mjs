var _a, _b, _c, _d;
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, defineAsyncComponent, version, unref, nextTick, watchEffect, shallowRef, toRaw, isReactive, effectScope, markRaw, watch, onUnmounted, toRefs, provide, onErrorCaptured, useSSRContext, withCtx, createVNode, createTextVNode, Suspense, Transition, mergeProps, createApp } from "vue";
...
const main = "";
const components = {
  ContentDoc: defineAsyncComponent(() => import("./_nuxt/ContentDoc.f5a3ee86.js").then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import("./_nuxt/ContentList.a394186f.js").then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import("./_nuxt/ContentNavigation.7a297cdf.js").then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import("./_nuxt/ContentQuery.da3e4604.js").then((n) => n.C).then((c) => c.default || c)),
  ContentRenderer: defineAsyncComponent(() => import("./_nuxt/ContentRenderer.986b747c.js").then((c) => c.default || c)),
  ContentRendererMarkdown: defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown.bfaa1d24.js").then((c) => c.default || c)),
  ContentSlot: defineAsyncComponent(() => import("./_nuxt/ContentSlot.66897d07.js").then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import("./_nuxt/Markdown.aa889ae1.js").then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import("./_nuxt/ProseA.e5f67408.js").then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.40ca32aa.js").then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import("./_nuxt/ProseCode.13984d8d.js").then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.d56a9904.js").then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import("./_nuxt/ProseEm.3d2da72b.js").then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import("./_nuxt/ProseH1.94b0ec70.js").then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import("./_nuxt/ProseH2.b33fef92.js").then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import("./_nuxt/ProseH3.6ce0855a.js").then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import("./_nuxt/ProseH4.233be54e.js").then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import("./_nuxt/ProseH5.8d789907.js").then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import("./_nuxt/ProseH6.2bf46a1d.js").then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import("./_nuxt/ProseHr.c6681087.js").then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import("./_nuxt/ProseImg.4debdb73.js").then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import("./_nuxt/ProseLi.27989fd1.js").then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import("./_nuxt/ProseOl.754d8a45.js").then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import("./_nuxt/ProseP.78cfc363.js").then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import("./_nuxt/ProseStrong.911dc7a2.js").then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import("./_nuxt/ProseTable.dc63e119.js").then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import("./_nuxt/ProseTbody.7fa272b0.js").then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import("./_nuxt/ProseTd.4685cb5b.js").then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import("./_nuxt/ProseTh.77b3fca2.js").then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import("./_nuxt/ProseThead.d00e43d6.js").then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import("./_nuxt/ProseTr.2d06b552.js").then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import("./_nuxt/ProseUl.2da7743b.js").then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/Home.642585c4.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.5d1761b5.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.b88e55e4.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
