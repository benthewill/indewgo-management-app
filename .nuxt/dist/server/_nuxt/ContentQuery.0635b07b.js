import { ref, onServerPrefetch, unref, defineComponent, toRefs, computed, watch, useSlots, useSSRContext, h } from "vue";
...
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils.f30c7f16.js";
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db.9105d9bb.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=ContentQuery.0635b07b.js.map
