globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { preprocess } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/remark-rehype/index.js';
import { all } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/detab/index.js';
import { u } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/unist-builder/index.js';
import { encode } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/mdurl/index.js';
import slugify from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/slugify/slugify.js';
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _Xtm9vp = defineEventHandler(async (event) => {
  const now = Date.now();
...
const _3bbfoB = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_n3bs4V = () => Promise.resolve().then(function () { return fetchingCityDetails$1; });
...
const handlers = [
  ...
  { route: '/api/fetchingCityDetails', handler: _lazy_n3bs4V, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.json', handler: _Xtm9vp, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _3bbfoB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _3bbfoB, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_nqHu0m, lazy: true, middleware: false, method: undefined }
];
...
const location_post = defineEventHandler(async (event) => {
  ...
  async function main(addressesArray, lotID) {
    ...
    return await graphQLClient.request(newAddressesDetails, addressesVariables).then((res) => {
...
const location_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': location_post
});

const general_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  async function main(name, number) {
    ...
    gql`
        ...
        `;
    const data = await graphQLClient.request(newGeneralLot, generalVariables).then((res) => {
...
const general_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': general_post
});
...
const fetchingParkingLots = defineEventHandler((event) => {
  async function main() {
    ...
    let arr = [];
    while (currentPaging) {
      const data = await graphQLClient.request(getLotsHome, {
        after: nextCursor
      });
...
const fetchingParkingLots$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': fetchingParkingLots
});

const fetchingCityDetails = defineEventHandler((event) => {
  async function main() {
    const endpoint = "https://rlwhlhzwqjpgcskfmeik.supabase.co/graphql/v1";
    const graphQLClient = new GraphQLClient(endpoint, {
      headers: {
    ...
    return await graphQLClient.request(getCityDetails).then((res) => res.city_detailsCollection.edges);
  }
  return main();
});

const fetchingCityDetails$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': fetchingCityDetails
});
...
const getClientManifest = () => import('/Users/benthewill/Library/Mobile Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/benthewill/Library/Mobile Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<script src=\"https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
