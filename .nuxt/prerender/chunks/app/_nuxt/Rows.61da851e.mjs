import { useSSRContext, resolveComponent, mergeProps, ref } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderComponent } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($props.content, (rateItem) => {
    ...
    _push(`<div class="tags are-small"><!--[-->`);
    ...
    _push(`<!--]--></div></p></div><div class="column"><p><span class="heading">Clearance</span><span class="subtitle is-6">SU UG</span></p></div><div class="column"><p><span class="heading">Placeholder</span><span class="subtitle is-6">true</span></p></div></div></div></div></div>`);
  });
  _push(`<!--]-->`);
}
...
//# sourceMappingURL=Rows.61da851e.mjs.map
