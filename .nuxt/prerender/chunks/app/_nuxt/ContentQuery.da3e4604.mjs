import { ref, defineComponent, toRefs, computed, useSlots, useSSRContext, h } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue/index.mjs';
import { b as useNuxtApp, c as useRequestEvent } from '../server.mjs';
...
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.0e544d66.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.6d708b03.mjs').then((m) => m.useContentDatabase());
...
export { ContentQuery as C, _sfc_main as _, assertArray as a, apply as b, withKeys as c, createQuery as d, ensureArray as e, get as g, jsonStringify as j, sortList as s, useCookie as u, withoutKeys as w };
//# sourceMappingURL=ContentQuery.da3e4604.mjs.map
