import { u as useRoute, f as appLayoutTransition, g as _wrapIf, b as useNuxtApp, h as useState, a as useHead, _ as _export_sfc, i as __nuxt_component_0$1 } from '../server.mjs';
...
import { u as useAsyncData } from './asyncData.b13700b2.mjs';
...
import { j as jsonStringify, u as useCookie } from './ContentQuery.da3e4604.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.0e544d66.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue/server-renderer/index.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.6d708b03.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./ContentDoc.f5a3ee86.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.a394186f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.da3e4604.mjs').then((n) => n.C).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.986b747c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.bfaa1d24.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.66897d07.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.aa889ae1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.e5f67408.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.40ca32aa.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.13984d8d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.d56a9904.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.3d2da72b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.94b0ec70.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.b33fef92.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.6ce0855a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.233be54e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.8d789907.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.2bf46a1d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.c6681087.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.27989fd1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.754d8a45.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.78cfc363.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.911dc7a2.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.dc63e119.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.7fa272b0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.4685cb5b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.77b3fca2.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.d00e43d6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.2d06b552.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.2da7743b.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.7a297cdf.mjs.map
