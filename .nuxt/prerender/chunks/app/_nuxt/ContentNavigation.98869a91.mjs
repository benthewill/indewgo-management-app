import { u as useRoute, e as appLayoutTransition, f as _wrapIf, a as useNuxtApp, g as useState, _ as _export_sfc, h as __nuxt_component_0$1 } from '../server.mjs';
import { defineComponent, h, inject, computed, unref, Transition, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, useSlots, useSSRContext, mergeProps, createElementVNode } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue/index.mjs';
import { a as useAsyncData, j as jsonStringify, u as useCookie } from './ContentQuery.0635b07b.mjs';
...
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.f30c7f16.mjs';
...
import { useRoute as useRoute$1 } from 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/vue-router/dist/vue-router.node.mjs';
...
import 'file:///Users/benthewill/Library/Mobile%20Documents/com~apple~CloudDocs/Indewgo/indewgo-management-app/node_modules/cookie-es/dist/index.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.9105d9bb.mjs').then((m) => m.generateNavigation);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))}><div><p class="is-size-6"> [GraphQL-Request Infinite Fetch Prototype v.0.5] <br> tech stack: <span class="tag is-primary is-light">vue.js</span><span class="tag is-link is-light">postgreSQL</span><span class="tag is-info is-light">bulma</span><span class="tag is-warning is-light">supabase</span><span class="tag is-link is-light">graphql-request</span></p></div><p class="is-size-6 pt-4"><strong>Indewgo</strong> - by benthewill. <br> Parking Lot Management App <br> The source code is licensed <a href="http://opensource.org/licenses/mit-license.php">MIT</a>. </p></div>`);
}
...
const Steps = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
const Steps$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Steps
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$1 = {
...
const welcome = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ff49b321"]]);
...
defineAsyncComponent(() => Promise.resolve().then(() => Footer$1).then((c) => c.default || c));
defineAsyncComponent(() => import('../server.mjs').then((n) => n.H).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => Steps$1).then((c) => c.default || c));
defineAsyncComponent(() => import('./step-one.fb9d6641.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.R).then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.S).then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.D).then((c) => c.default || c));
defineAsyncComponent(() => import('./Rows.61da851e.mjs').then((n) => n.M).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentDoc.97d39b0c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.21a5a747.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.0635b07b.mjs').then((n) => n.C).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.e5c3fd59.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.2bebb955.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.2e8c5b3c.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.f8be56dc.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.992e43db.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.c0fe3190.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.6f2f59d8.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.7717047f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.a60331d7.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.c30f1477.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.8213f95f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.fb1ebd6d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.dd0dcfe6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.8ed46a79.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.5404d56b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.e1aa79eb.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.8c69ded3.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.329ed22d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.d5b4f3bd.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.59218617.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.9f1f7b3a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.c5e3156c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.590dc7d0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.97fb6184.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.65b2faed.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.85d6afe3.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.719bc492.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.98869a91.mjs.map
